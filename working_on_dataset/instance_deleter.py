...
for user in data:
    ...
    user["location"].pop("coordinates", None)
    counter += 1
...
print(f"Numero di chiavi 'coordinates' mancanti: {elementi_mancanti}")
# print(f"Numero di chiavi 'taster_twitter_handle' mancanti: {elementi_mancanti_1}")
print(f"Numero di chiavi 'coordinates' eliminate: {counter}")
...
with open(r'C:\Users\franc\OneDrive - University of Pisa\Documenti\_Progetti magistrale\Large\datasets\users_new.json', 'w', encoding='utf-8') as f:
