...
public class UpdateVintageDTO {
    ...
    @Schema(description = "Wine ID info of the vintage", example = "1")
    private Long wineId;

    @PositiveOrZero(message = "Year info must be a positive number.")
    @Schema(description = "Year info of the vintage", example = "2000")
    private Integer year;
    
    @Positive(message = "Price info must be a positive number.")
    @NotNull(message = "Price info cannot be blank.")
    @Schema(description = "Price info of the vintage", example = "19.99")
    private Double price;

    @Schema(description = "Image info of the vintage", example = "https://example.com/image.jpg")
